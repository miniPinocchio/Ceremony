...
public class OkHttpClientManager {
	...
	public static <T> void downloadAsyn(String url, String destDir, ResultCallback<T> callback) {
	 ...
	 * @param callback
	 */
	private <T> void _downloadAsyn(final String url, final String destFileDir, final ResultCallback<T> callback) {
		final Request request = new Request.Builder()
				.url(url)
				.build();
	...
	private <T> void sendFailedStringCallback(final Request request, final Exception e, final ResultCallback<T> callback) {
		mDelivery.post(new Runnable() {
	...
	@SuppressWarnings("unchecked")
	private <T> void sendSuccessResultCallback(final Object object, final ResultCallback<T> callback) {
		mDelivery.post(new Runnable() {
